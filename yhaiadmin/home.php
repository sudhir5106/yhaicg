        ...
        <div class="row">          
          ...
          <div class="col-md-6 ">
            <div class="dashboard-link">
             ...
             <a href="<?php echo PATH_ADMIN?>/activity" class="shortcut"><i class="fa fa-crosshairs" aria-hidden="true"></i> <span class="shortcut-label">Activity</span> </a>              
             ...
             <a href="<?php echo PATH_ADMIN?>/news-event" class="shortcut"><i class="fa fa-newspaper-o" aria-hidden="true"></i>  <span class="shortcut-label">News & Events</span> </a>  
              
             <a href="<?php echo PATH_ADMIN?>/our-hostel" class="shortcut"><i class="fa fa-hospital-o" aria-hidden="true"></i>  <span class="shortcut-label">Our Hostel</span> </a>  
