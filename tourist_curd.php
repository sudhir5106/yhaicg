...
?>
     ...
     <form name="planresult" id="planresult">
                           <?php 
 if($district){echo $sql="SELECT Title, About_Place, Image FROM tourist_places where District_Id=".$district; }
 else
 {
 $sql="SELECT tourist_places.Title, tourist_places.About_Place,tourist_places.Image, district_master.District_id,district_master.District_name FROM tourist_places  LEFT JOIN district_master ON (district_master.District_id = tourist_places.District_id) WHERE 1=1 ORDER BY District_id ASC";
 }
